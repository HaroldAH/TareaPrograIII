...
-- Dumping structure for table rutinasdb.tmp_coaches
CREATE TABLE IF NOT EXISTS `tmp_coaches` (
...
-- Dumping structure for table rutinasdb.tmp_owners
CREATE TABLE IF NOT EXISTS `tmp_owners` (
...
-- Dumping structure for table rutinasdb.tmp_users
